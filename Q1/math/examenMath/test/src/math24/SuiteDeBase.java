package math24; /** Classe math24.math23.SuiteDeBase. Classe concrète qui sert de base pour la classe math24.math23.Suite.
    Cette classe fournit les outils de base pour travailler sur des suites de math24.math23.Elt
...
public class SuiteDeBase implements Cloneable, Iterable<Elt>{
	...
	public void couper() {
		if (this.estVide())
			throw new MathException(
					"Opération illégale sur une math24.math23.Suite vide : couper().");
		version = version + 1;
	...
	public Elt tete() {
		if (this.estVide())
			throw new MathException(
					"Opération illégale sur une math24.math23.Suite vide : tête().");
	...
	public SuiteDeBase corps() {
		if (this.estVide())
			throw new MathException(
					"Opération illégale sur une math24.math23.Suite vide : corps().");
		return this.tete.corps.clone();
	}

	/** Renvoie true ssi la math24.math23.Suite courante est vide */
	public boolean estVide() {
		return (this.tete == null);
	}

	/** Renvoie une description parenthèsée de la math24.math23.Suite courante */
	...
	/** Renvoie un itérateur sur la math24.math23.Suite courante */
