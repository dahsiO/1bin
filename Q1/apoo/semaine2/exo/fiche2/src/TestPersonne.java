public class TestPersonne {
    public static void main(String[] args) {
        ...
        Personne p1 = new Personne("Durand", "Marie", new Date(2005,22,03), adresse1 );
        Personne p2 = new Personne("Martin", "Paul", new Date(2005,22,02),adresse1 );
        Personne p3 = new Personne("Dupont", "Claire",new Date(2005,22,01), adresse1);
