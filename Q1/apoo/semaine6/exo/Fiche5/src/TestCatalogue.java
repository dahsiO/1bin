...
public class TestCatalogue {
	public static void main(String[] args) {
		...
		System.out.println("Livre livre 1 présent dans le catalogue : " + c.contientLivre(livre1));
		...
		System.out.println("Livre avec l'isbn 978-2290107096 : " + c.recupererLivre("978-2290107096"));
