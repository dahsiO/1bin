...
public class ListeRecCaracteres {
	...
	private int nombreOccurrences( NoeudCaractere Noeud,char caractereRecherche) {
		if (Noeud == null) {
			return 0;//arret instantaner on stop direct c est vide ya rien
		}
		int compte = 0;
		...
		//cas resccursives
		return compte+nombreOccurrences(Noeud.suivant,caractereRecherche);
	}
	/**
	...
	private void remplacer (NoeudCaractere noeud,char caractereARemplacer, char nouveauCaractere){
		...
		// si c est trouver  sinon suivant recursivement
