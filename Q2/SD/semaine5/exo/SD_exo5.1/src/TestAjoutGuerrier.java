...
// test 7 : il n'y a plus qu'un guerrier en vie (g1) - le nouveau guerrier (g5) se place apres lui
        ...
        g4 = new Guerrier(4,0);
        g5 = new Guerrier(5,6);
        ArrayList<Guerrier> a7 = new ArrayList<Guerrier>();
        a7.add(g1);
        a7.add(g2);
        a7.add(g3);
        a7.add(g4);
        LinkedList<Guerrier> l7 = new LinkedList<Guerrier>();
        l7.add(g1);
        EquipeGuerriers equipe7 = new EquipeGuerriers(a7, l7, 6);

        //System.out.println("L'equipe avant ajout :");
        //System.out.println(equipe7.toString());

        //System.out.println("L'equipe obtenue :");
        equipe7.ajouterNouveauGuerrier();
        //System.out.println(equipe7.toString());

        ArrayList<Guerrier> aAttendu7 = new ArrayList<Guerrier>();
        aAttendu7.add(g1);
        aAttendu7.add(g2);
        aAttendu7.add(g3);
        aAttendu7.add(g4);
        aAttendu7.add(g5);
        LinkedList<Guerrier> lAttendu7 = new LinkedList<Guerrier>();
        lAttendu7.add(g1);
        lAttendu7.add(g5);
        EquipeGuerriers equipeAttendue7 = new EquipeGuerriers(aAttendu7, lAttendu7, 6);

        //System.out.println("l'equipe attendue :");
        //System.out.println(equipeAttendue7.toString());

        if(!equipe7.toString().equals(equipeAttendue7.toString())){
            System.out.println("Test 7 : g1 est le seul guerrier en vie");
            System.out.println("       : le nouveau guerrier g5 va se placer apres lui pour les combats");
            System.out.println("Attention, le test 7 a echoue.");
            System.out.println("Pour debugger, pensez a afficher l'equipe avant et apres ajout.");
            System.out.println("Ces affichages sont mis en // dans la classe de tests");
            return;
        }
