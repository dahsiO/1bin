...
public class TestListeAoutImplV3 {
    ...
    public static void main(String[] args)  {
        System.out.println("*********************************************");
        System.out.println("Programme Test pour la classe ListeAoutImplV3");
        System.out.println("*********************************************");
        int choix = 0;
        do {
            System.out.println();
    ...
    private static void testContient(){
        ...
        ListeAoutImplV3<Character> liste;
        ListeAoutImplV3<Character> listeAttendue;

        numTest++;
        System.out.println();
        System.out.println("Test"+numTest);
        tableTestee = new Character[]{'a','f','c','d','e','k'};
        liste = new ListeAoutImplV3<>(tableTestee);
        listeAttendue = new ListeAoutImplV3<>(tableTestee);
    ...
    private static void testSupprimerDernier(){
        ...
        liste = new ListeAoutImplV3<>(tableTestee);
        listeAttendue = new ListeAoutImplV3<>(tableAttendue);
