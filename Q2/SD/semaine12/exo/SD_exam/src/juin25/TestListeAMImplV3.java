...
public class TestListeAMImplV3<E> {
    ...
    public static void main(String[] args) {
        System.out.println("*******************************************");
        System.out.println("Programme Test pour la classe ListeAMImplV3");
        System.out.println("*******************************************");
        int choix = 0;
        do {
            System.out.println();
    ...
    private static void testContient() {
        ...
        ListeAMImplV3<Character> liste;
        ListeAMImplV3<Character> listeAttendue;

        numTest++;
        System.out.println();
        System.out.println("Test" + numTest);
        tableTestee = new Character[]{'a', 'f', 'c', 'd', 'e', 'k'};
        liste = new ListeAMImplV3<>(tableTestee);
        listeAttendue = new ListeAMImplV3<>(tableTestee);
    ...
    private static void testSupprimerDernier() {
        ...
        liste = new ListeAMImplV3<>(tableTestee);
        listeAttendue = new ListeAMImplV3<>(tableAttendue);
