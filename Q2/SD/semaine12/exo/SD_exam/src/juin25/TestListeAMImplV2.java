...
public class TestListeAMImplV2 {
    ...
    public static void main(String[] args)  {
        System.out.println("*******************************************");
        System.out.println("Programme Test pour la classe ListeAMImplV2");
        System.out.println("*******************************************");
        int choix = 0;
        do {
            System.out.println();
    ...
    private static void testContient(){
        ...
        ListeAMImplV2<Character> liste;
        ListeAMImplV2<Character> listeAttendue;
        numTest++;
        System.out.println();
        System.out.println("Test"+numTest);
        tableTestee = new Character[]{'a','f','c','d','e','k'};
        liste = new ListeAMImplV2<>(tableTestee);
        listeAttendue = new ListeAMImplV2<>(tableTestee);
    ...
    private static void testSupprimerDernier(){
        ...
        liste = new ListeAMImplV2<>(tableTestee);
        listeAttendue = new ListeAMImplV2<>(tableAttendue);
