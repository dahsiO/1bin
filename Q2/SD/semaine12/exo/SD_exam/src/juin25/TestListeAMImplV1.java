...
public class TestListeAMImplV1 {
    private static Scanner scanner = new Scanner(System.in);

    static Class classe = ListeAMImplV1.class;
    static Field t;
    static Field taille;
    ...
    public static void main(String[] args) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        System.out.println("*******************************************");
        System.out.println("Programme Test pour la classe ListeAMImplV1");
        System.out.println("*******************************************");
        int choix = 0;
    ...
    private static void testContient() throws IllegalAccessException{
        ...
        liste = new ListeAMImplV1<>(tableTestee);
        ...
        liste = new ListeAMImplV1<>(tableTestee,5);
        ...
        liste = new ListeAMImplV1<>(tableTestee,0);
