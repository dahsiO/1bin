...
public class TestListeAoutImplV2<E> {
    ...
    public static void main(String[] args) {
        System.out.println("*********************************************");
        System.out.println("Programme Test pour la classe ListeAoutImplV2");
        System.out.println("*********************************************");
        int choix = 0;
        do {
            System.out.println();
    ...
    private static void testContient() {
        ...
        ListeAoutImplV2<Character> liste;
        ListeAoutImplV2<Character> listeAttendue;

        numTest++;
        System.out.println();
        System.out.println("Test" + numTest);
        tableTestee = new Character[]{'a', 'f', 'c', 'd', 'e', 'k'};
        liste = new ListeAoutImplV2<>(tableTestee);
        listeAttendue = new ListeAoutImplV2<>(tableTestee);
        ...
        try {
            ...
            assertEquals("Test" + numTest + " ko nombre elements presents dans le map ko : ", 6, liste.taille());
    ...
    private static void testSupprimerDernier() {
        ...
        liste = new ListeAoutImplV2<>(tableTestee);
        listeAttendue = new ListeAoutImplV2<>(tableAttendue);
        ...
        try {
            ...
            assertEquals("Test" + numTest + " ko apres suppression, nombre elements presents dans le map ko :", 6, liste.taille());
        ...
        try {
            ...
            assertEquals("Test" + numTest + " ko apres suppression, nombre elements presents dans le map ko :", 4, liste.taille());
            assertEquals("Test" + numTest + " ko apres suppression, probleme dans le chainage dans le sens --> :",listeAttendue.teteQueue(),liste.teteQueue());
            assertEquals("Test" + numTest + " ko apres suppression, probleme dans le chainage dans le sens <-- :",listeAttendue.queueTete(),liste.queueTete());
        } catch (Exception e) {
            System.out.println("Test" + numTest + " ko");
        ...
        try {
            ...
            assertEquals("Test" + numTest + " ko apres suppression, nombre elements presents dans le map ko :", 3, liste.taille());
            assertEquals("Test" + numTest + " ko apres suppression, probleme dans le chainage dans le sens --> :",listeAttendue.teteQueue(),liste.teteQueue());
            assertEquals("Test" + numTest + " ko apres suppression, probleme dans le chainage dans le sens <-- :",listeAttendue.queueTete(),liste.queueTete());
        } catch (Exception e) {
            System.out.println("Test" + numTest + " ko");
        ...
        try {
            assertEquals("Test" + numTest + " ko  caractere renvoye ko :", 'b', liste.supprimerDernier());
            assertEquals("Test" + numTest + " ko apres suppression, nombre elements presents dans le map ko :", 1, liste.taille());
            assertEquals("Test" + numTest + " ko apres suppression, probleme dans le chainage dans le sens --> :",listeAttendue.teteQueue(),liste.teteQueue());
            assertEquals("Test" + numTest + " ko apres suppression, probleme dans le chainage dans le sens <-- :",listeAttendue.queueTete(),liste.queueTete());
        } catch (Exception e) {
            System.out.println("Test" + numTest + " ko");
        ...
        try {
            ...
            assertEquals("Test" + numTest + " ko apres suppression, nombre elements presents dans le map ko :", 0, liste.taille());
            assertEquals("Test" + numTest + " ko apres suppression, probleme dans le chainage dans le sens --> :",listeAttendue.teteQueue(),liste.teteQueue());
            assertEquals("Test" + numTest + " ko apres suppression, probleme dans le chainage dans le sens <-- :",listeAttendue.queueTete(),liste.queueTete());
        } catch (Exception e) {
            System.out.println("Test" + numTest + " ko");
