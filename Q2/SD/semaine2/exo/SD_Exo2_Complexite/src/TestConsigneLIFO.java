...
public class TestConsigneLIFO {
    ...
    static Class classe = ConsigneLIFO.class;
    static Field table;
    static Field pile;
    ...
    public static void main(String[] args) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        ...
        System.out.println("******************************************");
        System.out.println("Programme Test pour la classe ConsigneLIFO");
        System.out.println("******************************************");

        table = classe.getDeclaredField("tableCasiers");
        table.setAccessible(true);
        pile = classe.getDeclaredField("arrayListCasiersLibres");
    ...
    private static void testConstructeur(ConsigneLIFO consigneAttendue, int nombreCasiers) {
        if (nombreCasiers <= 0) {
            try {
                new ConsigneLIFO(nombreCasiers);
            ...
            try {
                ConsigneLIFO consigneApresAppel = new ConsigneLIFO(nombreCasiers);
                ...
                ArrayList<Casier> pileApresAppel = (ArrayList<Casier>) pile.get(consigneApresAppel);
    ...
    private static void testResteUnCasierLibre() throws IllegalArgumentException, IllegalAccessException {
        ...
        ConsigneLIFO consigneLIFO = incoherent1();
        try {
            if (consigneLIFO.resteUnCasierLibre()) {
                System.out.println();
    ...
    private static void testResteUnCasierLibre(ConsigneLIFO consigneTestee) throws IllegalArgumentException, IllegalAccessException {
        Casier[] tableTestee = (Casier[]) table.get(consigneTestee);
        String tableTesteeString = Arrays.toString(tableTestee);
        ArrayList<Casier> pileTestee = (ArrayList<Casier>) pile.get(consigneTestee);
        ...
        try {
            ...
            ArrayList<Casier> pileApresAppel = (ArrayList<Casier>) pile.get(consigneTestee);
    ...
    private static void testAttribuerCasierLibre(ConsigneLIFO consigneTestee, ConsigneLIFO consigneAttendue, String motDePasse) throws IllegalArgumentException, IllegalAccessException {
        Casier[] tableTestee = (Casier[]) table.get(consigneTestee);
        ArrayList<Casier> pileTestee = (ArrayList<Casier>) pile.get(consigneTestee);
        ...
        if (motDePasse == null || motDePasse.length() == 0) {
            try {
                ...
                Casier[] tableAttendue = (Casier[]) table.get(consigneAttendue);
                ArrayList<Casier> pileAttendue = (ArrayList<Casier>) pile.get(consigneAttendue);
                Casier[] tableApresAppel = (Casier[]) table.get(consigneTestee);
                ArrayList<Casier> pileApresAppel = (ArrayList<Casier>) pile.get(consigneTestee);
        ...
        try {
            Casier casierAttribue = tableTestee[pileTestee.getLast().getNumero()];
            assertEquals("test ko : numero casier attribue : ko ", pileTestee.getLast().getNumero(), consigneTestee.attribuerCasierLibre(motDePasse));
            Casier[] tableAttendue = (Casier[]) table.get(consigneAttendue);
            ArrayList<Casier> pileAttendue = (ArrayList<Casier>) pile.get(consigneAttendue);
            Casier[] tableApresAppel = (Casier[]) table.get(consigneTestee);
            ArrayList<Casier> pileApresAppel = (ArrayList<Casier>) pile.get(consigneTestee);
    ...
    private static void testLibererCasier(ConsigneLIFO consigneTestee, ConsigneLIFO consigneAttendue, int numeroCasierALiberer, String motDePasse) throws IllegalArgumentException, IllegalAccessException {
        Casier[] tableTestee = (Casier[]) table.get(consigneTestee);
        ArrayList<Casier> pileTestee = (ArrayList<Casier>) pile.get(consigneTestee);
        System.out.println("pile : " + pileTestee.toString());
        System.out.println("table : " + Arrays.toString(tableTestee));
    ...
    private static ConsigneLIFO enonce() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
        ...
        table.set(ConsigneLIFO, tableTestee);
        pile.set(ConsigneLIFO, pileTestee);
        return ConsigneLIFO;
    }

    //attention ce ne sont pas les memes objets que la ConsigneLIFO cree apres appel de enonce()
    //Pour les comparaisons --> equals() ou toString()
    private static ConsigneLIFO enonceMoins2() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
        Casier[] tableTestee = new Casier[4];
        ArrayList<Casier> pileTestee = new ArrayList<>();
        for (int i = 0; i < 4; i++) {
    ...
    //attention ce ne sont pas les memes objets que la ConsigneLIFO cree apres appel de enonce()
    //Pour les comparaisons --> equals() ou toString()
    private static ConsigneLIFO enonceMoins0() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
        Casier[] tableTestee = new Casier[4];
        ArrayList<Casier> pileTestee = new ArrayList<>();
        for (int i = 0; i < 4; i++) {
    ...
    //attention ce ne sont pas les memes objets que la ConsigneLIFO cree apres appel de enonce()
    //Pour les comparaisons --> equals() ou toString()
    private static ConsigneLIFO enonceApresAttribution() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
        Casier[] tableTestee = new Casier[4];
        ArrayList<Casier> pileTestee = new ArrayList<>();
        for (int i = 0; i < 4; i++) {
    ...
    private static ConsigneLIFO tousLibres10() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
    ...
    private static ConsigneLIFO tousLibres7() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
    ...
    //attention ce ne sont pas les memes objets que la ConsigneLIFO cree apres appel de tousLibres7()
    //Pour les comparaisons --> equals() ou toString()
    private static ConsigneLIFO tousLibres7ApresAttribution() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
        Casier[] tableTestee = new Casier[7];
        ArrayList<Casier> pileTestee = new ArrayList<>();
        for (int i = 0; i < 7; i++) {
    ...
    private static ConsigneLIFO tousOccupes5() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
    ...
    private static ConsigneLIFO tousOccupes5Moins4() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
        Casier[] tableTestee = new Casier[5];
        ArrayList<Casier> pileTestee = new ArrayList<>();
        for (int i = 0; i < 5; i++) {
    ...
    //Feu rouge
    private static ConsigneLIFO incoherent1() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
        Casier[] tableTestee = new Casier[4];
        ArrayList<Casier> pileTestee = new ArrayList<>();
        for (int i = 0; i < 4; i++) {
    ...
    //But : verifier que la methode resteUnCasierLibre utilise la pile --> cout O(1)
    //Feu rouge
    private static ConsigneLIFO incoherent2() throws IllegalArgumentException, IllegalAccessException {
        ConsigneLIFO ConsigneLIFO = new ConsigneLIFO();
        Casier[] tableTestee = new Casier[4];
        ArrayList<Casier> pileTestee = new ArrayList<>();
        for (int i = 0; i < 4; i++) {
