...
public class TestConsigne {
    ...
    static Class classe = Consigne.class;
    static Field table;
    static Field pile;
    ...
    public static void main(String[] args) throws SecurityException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException {
        ...
        System.out.println("**************************************");
        System.out.println("Programme Test pour la classe Consigne");
        System.out.println("**************************************");

        table = classe.getDeclaredField("tableCasiers");
        table.setAccessible(true);
        pile = classe.getDeclaredField("pileCasiersLibres");
    ...
    private static void testConstructeur(Consigne consigneAttendue, int nombreCasiers) {
        if (nombreCasiers <= 0) {
            try {
                new Consigne(nombreCasiers);
            ...
            try {
                Consigne consigneApresAppel = new Consigne(nombreCasiers);
                ...
                for (int i = 0; i < nombreCasiers; i++) {
                    numerosApresAppel.add(pileApresAppel.pop().getNumero());
                }
    ...
    private static void testResteUnCasierLibre() throws IllegalArgumentException, IllegalAccessException {
        ...
        Consigne consigne = incoherent1();
        try {
            if (consigne.resteUnCasierLibre()) {
                System.out.println();
    ...
    private static void testResteUnCasierLibre(Consigne consigneTestee) throws IllegalArgumentException, IllegalAccessException {
        Casier[] tableTestee = (Casier[]) table.get(consigneTestee);
        String tableTesteeString = Arrays.toString(tableTestee);
        Pile<Casier> pileTestee = (Pile<Casier>) pile.get(consigneTestee);
        ...
        try {
            assertEquals("test ko : booleen : ko ", !pileTestee.estVide(), consigneTestee.resteUnCasierLibre());
            Casier[] tableApresAppel = (Casier[]) table.get(consigneTestee);
            Pile<Casier> pileApresAppel = (Pile<Casier>) pile.get(consigneTestee);
    ...
    private static void testAttribuerCasierLibre(Consigne consigneTestee, Consigne consigneAttendue, String motDePasse) throws IllegalArgumentException, IllegalAccessException {
        Casier[] tableTestee = (Casier[]) table.get(consigneTestee);
        Pile<Casier> pileTestee = (Pile<Casier>) pile.get(consigneTestee);
        ...
        if (motDePasse == null || motDePasse.length() == 0) {
            try {
                ...
                Casier[] tableAttendue = (Casier[]) table.get(consigneAttendue);
                Pile<Casier> pileAttendue = (Pile<Casier>) pile.get(consigneAttendue);
                Casier[] tableApresAppel = (Casier[]) table.get(consigneTestee);
                Pile<Casier> pileApresAppel = (Pile<Casier>) pile.get(consigneTestee);
        ...
        try {
            Casier casierAttribue = tableTestee[pileTestee.sommet().getNumero()];
            assertEquals("test ko : numero casier attribue : ko ", pileTestee.sommet().getNumero(), consigneTestee.attribuerCasierLibre(motDePasse));
            Casier[] tableAttendue = (Casier[]) table.get(consigneAttendue);
            Pile<Casier> pileAttendue = (Pile<Casier>) pile.get(consigneAttendue);
            Casier[] tableApresAppel = (Casier[]) table.get(consigneTestee);
            Pile<Casier> pileApresAppel = (Pile<Casier>) pile.get(consigneTestee);
    ...
    private static void testLibererCasier(Consigne consigneTestee, Consigne consigneAttendue, int numeroCasierALiberer, String motDePasse) throws IllegalArgumentException, IllegalAccessException {
        Casier[] tableTestee = (Casier[]) table.get(consigneTestee);
        Pile<Casier> pileTestee = (Pile<Casier>) pile.get(consigneTestee);
        System.out.println("pile : " + pileTestee.toString());
        System.out.println("table : " + Arrays.toString(tableTestee));
        ...
        try {
            ...
            assertEquals("test ko : contenu table ko : ", Arrays.toString(tableAttendue), Arrays.toString(tableApresAppel));
            assertEquals("test ko : contenu pile ko : ", pileAttendue.toString(), pileApresAppel.toString());
            if(tableApresAppel[numeroCasierALiberer]!=casierALiberer || pileApresAppel.sommet()!=casierALiberer){
                System.out.println("table et pile : contenu ok");
    ...
    private static Consigne enonce() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
        Casier[] tableTestee = new Casier[4];
        Pile<Casier> pileTestee = new PileImpl<>();
        for (int i = 0; i < 4; i++) {
        ...
        pileTestee.push(tableTestee[1]);
        pileTestee.push(tableTestee[3]);
        table.set(consigne, tableTestee);
        pile.set(consigne, pileTestee);
        return consigne;
    }

    //attention ce ne sont pas les memes objets que la consigne cree apres appel de enonce()
    //Pour les comparaisons --> equals() ou toString()
    private static Consigne enonceMoins2() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
        Casier[] tableTestee = new Casier[4];
        Pile<Casier> pileTestee = new PileImpl<>();
        for (int i = 0; i < 4; i++) {
    ...
    //attention ce ne sont pas les memes objets que la consigne cree apres appel de enonce()
    //Pour les comparaisons --> equals() ou toString()
    private static Consigne enonceMoins0() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
        Casier[] tableTestee = new Casier[4];
        Pile<Casier> pileTestee = new PileImpl<>();
        for (int i = 0; i < 4; i++) {
    ...
    //attention ce ne sont pas les memes objets que la consigne cree apres appel de enonce()
    //Pour les comparaisons --> equals() ou toString()
    private static Consigne enonceApresAttribution() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
        Casier[] tableTestee = new Casier[4];
        Pile<Casier> pileTestee = new PileImpl<>();
        for (int i = 0; i < 4; i++) {
        ...
        tableTestee[0].setMotDePasse("mdp");
        tableTestee[2].setMotDePasse("blabla");
        tableTestee[3].setMotDePasse("xxx");
        pileTestee.push(tableTestee[1]);
        table.set(consigne, tableTestee);
        pile.set(consigne, pileTestee);
        return consigne;
    ...
    private static Consigne tousLibres10() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
    ...
    private static Consigne tousLibres7() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
    ...
    //attention ce ne sont pas les memes objets que la consigne cree apres appel de tousLibres7()
    //Pour les comparaisons --> equals() ou toString()
    private static Consigne tousLibres7ApresAttribution() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
        Casier[] tableTestee = new Casier[7];
        Pile<Casier> pileTestee = new PileImpl<>();
        for (int i = 0; i < 7; i++) {
        ...
        pileTestee.pop();
        tableTestee[6].setMotDePasse("nv");
        table.set(consigne, tableTestee);
        pile.set(consigne, pileTestee);
        return consigne;
    }

    private static Consigne tousOccupes5() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
    ...
    private static Consigne tousOccupes5Moins4() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
        Casier[] tableTestee = new Casier[5];
        Pile<Casier> pileTestee = new PileImpl<>();
        for (int i = 0; i < 5; i++) {
    ...
    //Feu rouge
    private static Consigne incoherent1() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
        Casier[] tableTestee = new Casier[4];
        Pile<Casier> pileTestee = new PileImpl<>();
        for (int i = 0; i < 4; i++) {
    ...
    //But : verifier que la methode resteUnCasierLibre utilise la pile --> cout O(1)
    //Feu rouge
    private static Consigne incoherent2() throws IllegalArgumentException, IllegalAccessException {
        Consigne consigne = new Consigne();
        Casier[] tableTestee = new Casier[4];
        Pile<Casier> pileTestee = new PileImpl<>();
        for (int i = 0; i < 4; i++) {
