...
public class TestABRDEntiers {
    ...
    private static void testInsere() {
        ...
        System.out.println("Au depart, l'arbre contient 12");
        System.out.println();
        ABRDEntiers a = new ABRDEntiers(12);
        ...
        System.out.println("ABR sans ex-aequo");
        System.out.println("Au depart, l'arbre est vide");
        System.out.println();
        ABRDEntiers v = new ABRDEntiers();
        System.out.println("insere 12");
        v.insere(12);
        assertEquals("insere 12 contenu ko", "12", v.toString());
        assertEquals("insere 12 taille ko", 1, v.taille());
        System.out.println(v.toStringLoic());
        ...
        System.out.println("insere 1, puis insere 2, puis insere 1");
        b.insere(1);
        b.insere(2);
        b.insere(1);
        assertEquals("contenu ko", "1 1 2", b.toString());
        System.out.println(b.toStringLoic());
        if (!b.testG()) {
            System.out.println("Gestion ex-aequo ko");
            System.out.println("Convention choisie en cas d'ex-aequo non respectee");
            System.out.println("Tout element situe dans un sous-arbre de gauche devra etre inferieur (<) a l’element racine de cet arbre.");
            System.out.println("Tout element situe dans un sous-arbre de droite devra lui etre superieur ou egal (>=).");
            System.exit(0);
        }
