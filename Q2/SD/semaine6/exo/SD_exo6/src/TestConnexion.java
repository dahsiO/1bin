public class TestConnexion{
	...
	public static void main(String[] args) throws IllegalArgumentException{
		...
		System.out.println("******************************************");
		System.out.println("Scenario de tests pour la classe Connexion");
		System.out.println("******************************************");

        Connexion c = new Connexion();

        System.out.println("Les tests suivent un scenario");
        System.out.println("Au depart, il n'y a aucune connexion");
        System.out.println();
		...
		if(c.nombreDeConnectes()!=1){
			System.out.println("Echec test 3, apres connexion du meme login, votre classe annonce 1 connecte de plus : "+ c.nombreDeConnectes()+" logins connectes!");
			return;
		}
		...
		System.out.println("Bravo! Tous les tests du scenario propose ont reussi!");
