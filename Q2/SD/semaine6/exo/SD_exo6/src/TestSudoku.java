...
public class TestSudoku {
	...
	public static void testSudokuClassique(){
		...
		System.out.print("test 1 : sudoku de l'enonce");
		...
		System.out.print("test 2 : probleme ligne");
		...
		System.out.print("test 3 : probleme colonne");
		...
		System.out.print("test 4 : probleme bloc");
	...
	private static void testSudokuDiagonal() {
		...
		System.out.print("test 1 : exemple de l'enonce qui n'est pas diagonal");
		...
		System.out.print("test 2 : sudoku diagonal de l'enonce");
	...
	private static void testHyperSudoku() {
		...
		// test 1 : grille correspondant au 1er exemple de l'enonce qui n'est pas hyperSudoku
        System.out.print("test 1 : exemple de l'enonce qui n'est pas hyperSudoku");
		...
		System.out.print("test 2 : hyperSudoku de l'enonce");
